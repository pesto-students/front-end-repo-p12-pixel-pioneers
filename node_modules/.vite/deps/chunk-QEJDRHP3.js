...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React2.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React2.useMemo(() => {
    return {
      min,
      max,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    actionContext: React2.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React3.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime2.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime.jsx)(Input, _extends({}, inputProps)), endAdornment]
  }));
});
true ? NumberInput.propTypes = {
   ...
   */
  shiftMultiplier: import_prop_types.default.number,
  /**
   * The props used for each slot inside the NumberInput.
   * @default {}
   */
  slotProps: import_prop_types.default.shape({
    decrementButton: import_prop_types.default.oneOfType([import_prop_types.default.func, import_prop_types.default.object]),
    incrementButton: import_prop_types.default.oneOfType([import_prop_types.default.func, import_prop_types.default.object]),
  ...
  slots: import_prop_types.default.shape({
    decrementButton: import_prop_types.default.elementType,
    incrementButton: import_prop_types.default.elementType,
...
//# sourceMappingURL=chunk-QEJDRHP3.js.map
