...
var COMPONENT_NAME2 = "Menu";
function getMenuUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME2, slot);
}
var menuClasses = generateUtilityClasses(COMPONENT_NAME2, ["root", "listbox", "expanded"]);
...
function useListItem(parameters) {
  ...
  const createHandleClick = React10.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React10.useCallback((externalHandlers) => (event) => {
...
var CompoundComponentContext = React11.createContext(null);
...
function useCompoundParent() {
  const [subitems, setSubitems] = React11.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React11.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React11.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React11.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React11.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React11.useCallback(function getItemIndex2(id) {
...
function useCompoundItem(id, itemMetadata) {
  const context = React12.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React12.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
var COMPONENT_NAME3 = "Popup";
function getPopupUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME3, slot);
}
var popupClasses = generateUtilityClasses(COMPONENT_NAME3, ["root", "open"]);
...
function useTransitionStateManager() {
  const transitionContext = React18.useContext(TransitionContext);
...
var Menu = React22.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React23.useContext(DropdownContext);
  if (menuContext === null) {
...
var COMPONENT_NAME4 = "MenuButton";
function getMenuButtonUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME4, slot);
}
var menuButtonClasses = generateUtilityClasses(COMPONENT_NAME4, ["root", "active", "disabled", "expanded"]);

// node_modules/@mui/base/MenuButton/MenuButton.js
var import_jsx_runtime11 = __toESM(require_jsx_runtime());
var _excluded4 = ["children", "disabled", "label", "slots", "slotProps", "focusableWhenDisabled"];
...
var MenuButton = React24.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
var COMPONENT_NAME5 = "MenuItem";
function getMenuItemUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME5, slot);
}
var menuItemClasses = generateUtilityClasses(COMPONENT_NAME5, ["root", "disabled", "focusVisible"]);
...
function useMenuItem(params) {
  ...
  const itemMetadata = React25.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React25.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React26.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React26.useMemo(() => ({
    dispatch,
...
var _excluded5 = ["children", "disabled", "label", "id", "slotProps", "slots"];
...
var InnerMenuItem = React27.memo(React27.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
var MenuItem2 = React27.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var COMPONENT_NAME6 = "Modal";
function getModalUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME6, slot);
}
var modalClasses = generateUtilityClasses(COMPONENT_NAME6, ["root", "hidden", "backdrop"]);
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(React30.Fragment, {
...
var optionGroupClasses = generateUtilityClasses(COMPONENT_NAME7, ["root", "disabled", "label", "list"]);
...
var OptionGroup = React31.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
var optionClasses = generateUtilityClasses(COMPONENT_NAME8, ["root", "disabled", "selected", "highlighted"]);
...
var popperClasses = generateUtilityClasses(COMPONENT_NAME9, ["root"]);
...
var selectClasses = generateUtilityClasses(COMPONENT_NAME10, ["root", "button", "listbox", "popup", "active", "expanded", "disabled", "focusVisible"]);
...
var Select = React38.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React38.Fragment, {
    children: [(0, import_jsx_runtime21.jsx)(Button2, _extends({}, buttonProps, {
...
var sliderClasses = generateUtilityClasses(COMPONENT_NAME11, ["root", "active", "focusVisible", "disabled", "dragging", "marked", "vertical", "trackInverted", "trackFalse", "rail", "track", "mark", "markActive", "markLabel", "markLabelActive", "thumb"]);
...
var _excluded11 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "shiftStep", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
  ...
  return (0, import_jsx_runtime24.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime23.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime23.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime24.jsxs)(Thumb, _extends({
        ...
        children: [(0, import_jsx_runtime23.jsx)(Input2, _extends({
          "data-index": index2,
...
var snackbarClasses = generateUtilityClasses(COMPONENT_NAME12, ["root"]);
...
var switchClasses = generateUtilityClasses(COMPONENT_NAME13, ["root", "input", "track", "thumb", "checked", "disabled", "focusVisible", "readOnly"]);
...
var Switch = React44.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime26.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime26.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime26.jsx)(Input2, _extends({}, inputProps))]
  }));
});
...
var tablePaginationClasses = generateUtilityClasses(COMPONENT_NAME14, ["root", "toolbar", "spacer", "selectLabel", "selectRoot", "select", "selectIcon", "input", "menuItem", "displayedRows", "actions"]);
...
var tabPanelClasses = generateUtilityClasses(COMPONENT_NAME15, ["root", "hidden"]);
...
var tabsClasses = generateUtilityClasses(COMPONENT_NAME16, ["root", "horizontal", "vertical"]);
...
var tabsListClasses = generateUtilityClasses(COMPONENT_NAME17, ["root", "horizontal", "vertical"]);
...
var tabClasses = generateUtilityClasses(COMPONENT_NAME18, ["root", "selected", "disabled"]);
...
var TextareaAutosize = React58.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime39.jsxs)(React58.Fragment, {
...
var _excluded21 = ["children", "className", "enterAnimationName", "enterClassName", "exitAnimationName", "exitClassName"];
